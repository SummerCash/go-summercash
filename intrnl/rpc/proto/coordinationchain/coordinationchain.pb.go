...
func (*GeneralRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb31af2f141cd2b7, []int{0}
}
...
func (*GeneralResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb31af2f141cd2b7, []int{1}
}
...
func init() {
	proto.RegisterType((*GeneralRequest)(nil), "coordinationchain.GeneralRequest")
	proto.RegisterType((*GeneralResponse)(nil), "coordinationchain.GeneralResponse")
}

func init() { proto.RegisterFile("coordinationchain.proto", fileDescriptor_cb31af2f141cd2b7) }

var fileDescriptor_cb31af2f141cd2b7 = []byte{
