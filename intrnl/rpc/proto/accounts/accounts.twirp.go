...
type Accounts interface {
	...
	GetAllContracts(context.Context, *GeneralRequest) (*GeneralResponse, error)
...
func (c *accountsProtobufClient) GetAllContracts(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "accounts")
	ctx = ctxsetters.WithServiceName(ctx, "Accounts")
	ctx = ctxsetters.WithMethodName(ctx, "GetAllContracts")
	out := new(GeneralResponse)
...
func (c *accountsJSONClient) GetAllContracts(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "accounts")
	ctx = ctxsetters.WithServiceName(ctx, "Accounts")
	ctx = ctxsetters.WithMethodName(ctx, "GetAllContracts")
	out := new(GeneralResponse)
...
func (s *accountsServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/accounts.Accounts/GetAllAccounts":
		...
		return
	case "/twirp/accounts.Accounts/GetAllContracts":
		s.serveGetAllContracts(ctx, resp, req)
		return
...
func (s *accountsServer) serveGetAllContracts(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetAllContractsJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetAllContractsProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *accountsServer) serveGetAllContractsJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetAllContracts")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.Accounts.GetAllContracts(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *GeneralResponse and nil error while calling GetAllContracts. nil responses are not supported"))
		return
	}
...
func (s *accountsServer) serveGetAllContractsProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetAllContracts")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
